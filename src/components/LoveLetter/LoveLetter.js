        ...
        <div className={`envelope ${isOpen ? 'open' : ''}`} onClick={!isFullSize ? handleOpenLetter : handleCloseLetter}>
            ...
            <div className={`letter ${isFullSize ? 'fullSize' : ''}`} ref={letterRef}>
                <div className="letter-content" ref={letterContentRef}>  {/* Wrap content inside this for scrolling */}
                    My dearest Priyam,<br /><br />
                    How do I even begin to tell you how much you mean to me? Since the day you entered my life, everything has become brighter.<br />
                    ...
                    Chotu babu, you are the heartbeat of my life. Every moment I spend with you feels like I’ve found my entire world.<br />
                    You are not just a part of my life; you are my life, my everything.<br />
                    With you, each day brings new hope, new dreams. In your eyes, I see my home, and your laughter is the greatest joy in my life.<br /><br />
                    I don’t just love you; you are my world, my soul, my entire universe. When you’re close, my heart feels so full that words can’t even describe it.<br />
                    Every moment with you becomes a story—one that I want to keep forever close to my heart.<br /><br />
                    Every beat of my heart is for you, and my soul is forever connected to yours. Your love completes me, and I dream of always being by your side.<br />
                    Your happiness is my happiness, and your pain is my pain.<br /><br />
                    Chotu babu, you mean everything to me. I will always stand by you, ready to do anything for your happiness.<br />
